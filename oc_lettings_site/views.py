...
# Praesent dignissim, odio eu consequat pretium, purus urna vulputate arcu, vitae efficitur lacus justo nec purus.
...
def letting(request, letting_id):
    requested_letting = Letting.objects.get(id=letting_id)
    context = {
        'title': requested_letting.title,
        'address': requested_letting.address,
    }
